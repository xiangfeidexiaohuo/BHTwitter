...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        PSSpecifier *developer = [self newSectionWithTitle:[[BHTBundle sharedBundle] localizedStringForKey:@"DEVELOPER_SECTION_HEADER_TITLE"] footer:[NSString stringWithFormat:@"BHTwitter v4.4", [[BHTBundle sharedBundle] BHTwitterVersion]]];
